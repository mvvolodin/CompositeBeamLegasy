...
private:
	...
	double A_st_ = 0.;//Площадь стальной части сечения включая арматуру
	double S_st_ = 0.;//Статический момент стальной части сечения включая арматуру
    double I_st_ = 0.;//Момент инерции стальной части сечения включая арматуру
	...
	double Z_s_stb_ = 0.;//Расстояние между Ц.Т. сечений стальной и сталежелезобетонной балок
	double Z_b_st_ = 0.;//Расстояние между Ц.Т.бетонного сечения и стальной части включая арматуру
	double Z_s_st_ = 0.; //Расстояние между Ц.Т. сечений стальной балки и стальной части включая арматуру
	double Z_st_stb_ = 0.;//Расстояние между Ц.Т. стальной части сечения включая арматуру и сталежелезобетонного сечения
	double Z_b_stb_= 0.;  //Расстояние между Ц.Т. бетонного и сталежелезобетонного сечения
	double Z_r_u_stb_= 0.;//Расстояние между Ц.Т. сталежелезобетонного сечения и верхней арматурой
	double Z_r_l_stb_= 0.;//Расстояние между Ц.Т. сталежелезобетонного сечения и нижней арматурой
