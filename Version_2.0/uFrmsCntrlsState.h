...
struct TCompositeBeamMainFormCntrlsState{
	...
	double edt_dead_load_first_stage_data_ {0.5};
	...
	double edt_gamma_f_concrete_SW_data_ {1.2};
...
struct TStudDefinitionFormCntrlsState{
	...
	unsigned int cmb_bx_stud_part_number_index_{54};
	double edt_stud_yield_strength_data_{350};
	double edt_stud_safety_factor_data_{1.3};
	double edt_edge_studs_dist_data_{200};
	unsigned int cmb_bx_edge_studs_rows_num_index_{1};
	bool chck_bx_more_than_one_stud_per_corrugation_edge_data_{0};
	double edt_middle_studs_dist_data_{250};
	unsigned int cmb_bx_middle_studs_rows_num_index_{0};
