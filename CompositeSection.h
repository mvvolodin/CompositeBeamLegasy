...
public:
	double Alfa_s_;//коэффициент приведения к стали
	double Alfa_b_;//коэффициент приведения к бетону
	...
	double Z_st_red_;//Расстояние между центром тяжести стального и сталежелезобетонного сечения
	double I_red_;  //Момент инерции сталежелезобетонного сечения приведённого к металлу
	double Z_red_f2_;//Расстояние между Ц.Т. сталежелезобетонного сечения и наружней гранью верхней полки
	double Z_red_f1_; //Расстояние между Ц.Т. сталежелезобетонного сечения и наружней гранью нижней полки
	double Z_b_red_;  //Расстояние между Ц.Т. бетонного и сталежелезобетонного сечения
	double W_f2_red_; //Момент сопротивления сталежелезобетонного сечения для верхней полки
	double W_f1_red_; //Момент сопротивления сталежелезобетонного сечения для нижней полки
