...
static double tC235[N_C235+1]={2,4};//толщины

static double steelC245[N_C245][4]={245,370,240,360}; //Глоальная переменная с внутренним связыванием
