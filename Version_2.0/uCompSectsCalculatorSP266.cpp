...
CompSectsCalculatorSP266::CompSectsCalculatorSP266(
...
CompSectOutputSP266 CompSectsCalculatorSP266::calculate(Node const & node)
{
	...
	double const M_Rd = comp_sect_.M_Rd();
	...
	double const rigid_pl_ratio = M / M_Rd;
...
DesignCaseSP266 CompSectsCalculatorSP266::design_case(double const sigma_b, double const sigma_r)
{
